...
<div class="kt-grid kt-grid--hor kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        ...
        <!-- <x-admin-left-bar /> -->
        <Nav/>
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper right-panel-wpr" id="kt_wrapper">
...
<style>
@import '/public/admin_assets/vendors/general/bootstrap/dist/css/bootstrap.min.css';
...
body .kt-grid__item.kt-wrapper.right-panel-wpr {
    min-height: 100vh;
}
body .kt-grid__item.kt-wrapper .kt-grid__item.kt-grid.right-panel-cntnt-area {
    -webkit-box-flex: 1;
        -ms-flex-positive: 1;
            flex-grow: 1;
}
