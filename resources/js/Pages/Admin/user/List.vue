                        ...
                        <tbody v-auto-animate >
                            ...
                            <template v-for="user,index in users.data" :key="user.id">
                                <tr role="row" class="odd">
                                    <td class="sorting_1" tabindex="0">
                                        <div class="kt-user-card-v2">
                                            <div class="kt-user-card-v2__pic">
                                                    <img v-if="user.profile_photo != null" :src="user.profile_photo" style="width:150px; height:130px;">
                                    ...
                                    <td><a class="kt-link" href="mailto:{{user.email}}">{{user.email}}</a></td>
...
const form = reactive({
    ...
    active: filters.contract_end_date || '',
})
