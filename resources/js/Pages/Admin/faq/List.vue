        ...
        <Table :ListData="faqs">
            ...
            <template #TableHead>
                <!-- <TableTh @click="ListHelper.sortBy('question')">
                    ...
                    Question</TableTh> -->
                <TableTh @click="ListHelper.sortBy('question')"  style="width:30%">Question</TableTh>
                <TableTh @click="ListHelper.sortBy('answer')" style="width:40%">Answer</TableTh>
                <!-- <TableTh @click="ListHelper.sortBy('created_at')">Created at</TableTh> -->
                <TableTh :sorting=false style="width:20%">Status</TableTh>
            ...
            <template #TableBody>
                <tr role="row" class="odd" v-for="faq in faqs.data" :key="faq.id" >
                    <td class="sorting_1" tabindex="0">
                        ...
                        {{ faq.question.length > 200 ? faq.question.substring(0,200)+".." : faq.question }}
                    </td>
                    <td>{{ faq.answer.length > 200 ? faq.answer?.substring(0,210)+".." : faq.answer }}</td>
