<template lang="">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="kt_table_1_filter" class="dataTables_filter">
                           ...
                           <Link :href="route('admin.createGroupType')" class="btn btn-button kt-btn btn-sm kt-btn--icon button-fx">+ Add New</Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <table
                            ...
                            <thead>
                                <tr role="row">
                                    <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 20%;" aria-sort="ascending" aria-label="Agent: activate to sort column descending">Name <i
                                            class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" @click="ListHelper.sortBy('type')"></i>
                                    </th>
                            ...
                            <tbody v-auto-animate >
                                ...
                                <template v-for="type,index in groupTypes.data" :key="type.id">
                                    <tr role="row" class="odd">
                                        <td class="sorting_1" tabindex="0">
                                            <div class="kt-user-card-v2">
                                                <div class="kt-user-card-v2__details">
                                                    <span class="kt-user-card-v2__name">{{type.type}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td nowrap="" class="align-center"> <span class="dropdown"><a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown" >
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <Link class="dropdown-item" :href="route('admin.editGroupType',type.id)"><i class="la la-edit"></i> Edit</Link>
                                ...
                                <tr role="row" v-if="Object.keys(groupTypes.data).length == 0" class="odd text-center">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-5">
                    <div class="dataTables_info" id="kt_table_1_info" role="status" aria-live="polite">
                        Showing {{groupTypes.from}} to {{groupTypes.to}} of {{groupTypes.total}} entries
                    </div>
                </div>
    ...
    const {groupTypes, filters} = defineProps({ groupTypes: Object, filters:Object });
    ...
    onMounted(() => {
        emit.emit('pageName', 'Group Type Management',[{title: "Group Type List", routeName:"admin.groupTypes"}]);
    ...
    watch(form, debounce(() => {
            router.visit(route('admin.groupTypes'), {
            method: 'get',
            data: pickBy(form),
            preserveState: true
        });
    ...
    const deleteConfirm = (id) => {
        router.delete(route('admin.deleteGroupType',id), {
            preserveScroll: true,
        });
    }
    ...
    const changeStatusConfirm = (id) => {
        router.post(route('admin.changeGroupTypeStatus',id), {
            preserveScroll: true,
        })
    }
