...
// }
    ...
    public function share(Request $request): array
    {
        ...
        foreach($settings as $value ){
            if($value->key == 'logo'){
                $value->value = $value->value ? URL::route('image', ['path' => $value->value, 'w' => 100, 'h' => 45, 'fit' => 'stretch']) : asset('admin_assets/logo/logo.png');
            }
        ...
        return array_merge(parent::share($request), [
            ...
            'auth'=>[
                'user'=> [
                    ...
                    'profile_photo'=>  isset(auth()->user()->profile_photo_url) ? auth()->user()->profile_photo_url : null,
                  ]
                ],
            'baseUrl'=>url(),
